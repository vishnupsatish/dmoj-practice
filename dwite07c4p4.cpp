...
void get_adj(int i, int j) {
    if (a[i + 1][j] != 1 && i + 1 <= 10) adj.eb(i + 1, j);
    if (a[i - 1][j] != 1 && i - 1 >= 1) adj.eb(i - 1, j);
    if (a[i][j + 1] != 1 && j + 1 <= 10) adj.eb(i, j + 1);
    if (a[i][j - 1] != 1 && j - 1 >= 1) adj.eb(i, j - 1);
    if (a[i + 1][j + 1] != 1 && i + 1 <= 10 && j + 1 <= 10) adj.eb(i + 1, j + 1);
    if (a[i + 1][j - 1] != 1 && i + 1 <= 10 && j - 1 >= 1) adj.eb(i + 1, j - 1);
    if (a[i - 1][j + 1] != 1 && i - 1 >= 1 && j + 1 <= 10) adj.eb(i - 1, j + 1);
